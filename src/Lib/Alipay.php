 ...
 * Time: 10:17
 */
use Sepia\Alipay\Lib\AopClient;
use Sepia\Alipay\Request\AlipayTradeWapPayRequest;   //手机支付
use Sepia\Alipay\Request\AlipayTradePagePayRequest;  //电脑支付
use Sepia\Alipay\Request\AlipayTradeQueryRequest;
use Sepia\Alipay\Request\AlipayTradeRefundRequest;
use Sepia\Alipay\Request\AlipayTradeCloseRequest;
use Sepia\Alipay\Request\AlipayTradeFastpayRefundQueryRequest;
use Sepia\Alipay\Request\AlipayDataDataserviceBillDownloadurlQueryRequest;
...
//支付宝网关地址
    ...
    function __construct($alipay_config){
        ...
        $this->logger=$this->initializeLogger($alipay_config);
    }
    /**
     * Initialize logger.
     */
